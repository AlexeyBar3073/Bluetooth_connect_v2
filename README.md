...
| **Кнопка габаритов** | Тактовая кнопка | GPIO27 (INPUT_PULLUP) | Переключение габаритных огней |
| **Потенциометр** | 10 кОм | GPIO33 (ADC 12 бит) | «Педаль газа» для симулятора |
| **K-Line адаптер** | MC33290 | UART2 (TX=17, RX=16) | Опционально, для диагностики |
